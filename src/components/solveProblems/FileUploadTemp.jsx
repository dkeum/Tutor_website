          ...
          <div className="relative w-full max-w-xl mx-auto">
            ...
            {!files.length && (
              <motion.div
                ...
                className="absolute opacity-0 border border-dashed border-sky-400 inset-0 z-30 bg-transparent flex items-center justify-center h-16 w-16 mx-auto rounded-md"></motion.div>
            )}
          </div>
        </div>
      </motion.div>
