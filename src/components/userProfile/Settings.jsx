    ...
    <div className="min-h-screen w-full bg-[#FAFAFE] text-[#1C1B1F] flex font-sans">
      ...
      <div className="flex-1 ml-64 flex flex-col min-h-screen">
        ...
        <main className="p-12 max-w-[1100px] w-full mx-auto flex flex-col gap-8 flex-1">
          <div>
            <h2 className="text-3xl font-extrabold text-[#6200EE] tracking-tight">Settings</h2>
            <p className="text-sm text-gray-500 mt-1">Personalize your learning experience and manage your plan.</p>
          </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="bg-[#E6F4EA] text-[#137333] text-[10px] font-bold px-2 py-0.5 rounded-md uppercase tracking-wider">Active</span>
                  </div>
                  <div className="flex flex-wrap items-center gap-x-8 gap-y-2 mt-2">
                    <div>
                      <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider">Monthly Price</p>
                      <p className="text-sm font-bold text-gray-800">$9.99/mo</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider">Renewal Date</p>
                      <p className="text-sm font-bold text-gray-800">Dec 15, 2023</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider">Next Payment</p>
                      <p className="text-sm font-bold text-gray-800">$9.99 USD</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex items-center gap-5 pb-5 border-b border-gray-100">
                    <div className="relative cursor-pointer flex-shrink-0" onClick={handleAvatarClick}>
                      ...
                      />
                      <input type="file" id="avatar-input" accept="image/*" className="hidden" onChange={handleFileChange} />
                    </div>
                    <div>
                      <p className="text-sm font-bold text-gray-800">Profile Photo</p>
                      <p className="text-xs text-gray-400 mt-0.5 leading-relaxed">Update your avatar to appear across the leaderboard.</p>
                      <button onClick={handleAvatarClick} className="text-[#6200EE] font-bold text-xs mt-2 block hover:underline">Change Photo</button>
                    </div>
                  </div>
              ...
              <div className="flex flex-col justify-center h-[calc(100%-3rem)]">
                <div className="flex items-center justify-between py-2">
                  <div className="pr-4">
                    ...
                    <p className="text-xs text-gray-400 mt-0.5 leading-relaxed">Hear problems read aloud</p>
                  </div>
          ...
          <section className="w-full bg-[#FDF2F2] rounded-3xl p-6 border border-red-100/70 flex flex-col sm:flex-row items-center justify-between gap-4 mt-4">
            <div>
              <h3 className="text-md font-bold text-[#A61C1C] mb-0.5">Danger Zone</h3>
              <p className="text-xs text-gray-500 leading-normal">Deleting your account is permanent and will remove all your learning progress and Pro history.</p>
            </div>
            <button
