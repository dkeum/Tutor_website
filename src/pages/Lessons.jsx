...
const topics = [
  {
    ...
    subtopics: [
      { name: "Linear Equations & Inequalities", meta: "Video • 45 mins",        done: true  },
      { name: "Quadratic Functions",             meta: "Interactive • 1 hour",   done: false },
  ...
  },
  {
    ...
    subtopics: [
      { name: "Slope & Distance Formula", meta: "Document • 15 mins", done: true  },
  ...
  },
  {
    ...
    subtopics: [
      { name: "Sine, Cosine & Tangent Laws", meta: "Video • 1 hour",      done: true  },
      { name: "Trigonometric Ratios",        meta: "Interactive • 25 mins", done: false },
        ...
        <main className="mt-20 p-10 max-w-[1280px] w-full mx-auto flex-1 z-10 flex flex-col gap-12">
          ...
          <div>
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-[#cbc3d9]/30 flex gap-4 cursor-pointer items-center hover:shadow-md transition-shadow max-w-sm">
              ...
              />
              <div className="flex-1 min-w-0">
                <p className="text-sm font-bold text-[#101b30] truncate">{recentLesson.title}</p>
                <p className="text-[11px] text-[#494456] font-medium mb-2">{recentLesson.subject}</p>
                ...
                <p className="text-[10px] text-[#494456] mt-1">{recentLesson.progress}% complete</p>
              </div>
            </div>
          </div>
