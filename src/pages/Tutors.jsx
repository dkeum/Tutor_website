        ...
        <div className="flex-1 ml-64 flex flex-col min-h-screen">
          ...
          <main className="p-10 max-w-[1280px] w-full mx-auto flex-1 flex flex-col">
            ...
            <section className="mb-8">
              <h2
                className="text-4xl font-bold text-[#22005d] tracking-tight mb-2 text-left"
                style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
              >
                Find your math mentor
              </h2>
              <p className="text-lg text-[#494456] max-w-2xl text-left">
                Connect with expert tutors who specialize in making complex
                mathematics simple and engaging.
              </p>
            </section>
                ...
                >
                  ...
                  <div className="relative mb-6 overflow-hidden rounded-xl">
                    ...
                    <div className="absolute top-3 right-3 bg-white px-3 py-1 rounded-full flex items-center gap-1 shadow-sm">
                      ...
                      <span className="text-xs font-bold text-[#101b30]">
                        {tutor.rating}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs font-bold text-[#4800b2] mb-2">
                      {tutor.title}
                    </p>
                  ...
                  <div className="flex items-center justify-between mt-auto pt-4 border-t border-[#d7e2ff]">
                    <div>
                      <span className="text-2xl font-extrabold text-[#494456]">
                        ${tutor.price}
                      </span>
