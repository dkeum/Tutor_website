        ...
        <main className="w-full max-w-[480px] tracking-normal">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgba(43,86,222,0.06)] border border-[#e8edff] tracking-normal">
            ...
            <div className="mt-6 tracking-normal">
              <button className="w-full flex items-center justify-center space-x-3 py-3.5 px-4 rounded-xl border border-[#cbc3d9] hover:bg-[#f0f3ff] transition-all text-sm font-bold text-[#494456] active:scale-[0.98] tracking-normal cursor-pointer">
